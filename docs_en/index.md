---
description: Offensive security blog. Low-level techniques in x86-64 assembly for Linux, without libc.
---
...
<div class="razor-hero razor-hero--no-logo">
  <div class="razor-hero__content">
    ...
    <p class="razor-hero__subtitle">
      Technical notes about offensive security.
    </p>
...
<a href="research/malware-dev/" class="razor-card">
  ...
  <span class="razor-card__desc">Development and Breakdown of Offensive Techniques</span>
...
<a href="research/kernel-theory/" class="razor-card">
  ...
  <span class="razor-card__desc">Linux Kernel Theory from an Offensive Angle</span>
  <div class="razor-card__meta">
